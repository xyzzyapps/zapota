...
[![GitHub Actions status (format check)](https://github.com/bdwgc/bdwgc/actions/workflows/format-check.yml/badge.svg?event=push)](https://github.com/bdwgc/bdwgc/actions/workflows/format-check.yml?query=branch%3Amaster)
